...
if (esm) {
  targets = [{dest: `dist/react-toggled${library}.es.js`, format: 'es'}]
} else if (umd) {
  if (minify) {
    targets = [{dest: `dist/react-toggled${library}.umd.min.js`, format: 'umd'}]
  } else {
    targets = [{dest: `dist/react-toggled${library}.umd.js`, format: 'umd'}]
  }
} else if (cjs) {
  targets = [{dest: `dist/react-toggled${library}.cjs.js`, format: 'cjs'}]
} else if (format) {
